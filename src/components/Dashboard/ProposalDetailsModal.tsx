...
const ProposalDetailsModal: React.FC<ProposalDetailsModalProps> = ({ 
  ...
  // Debug logging
  console.log('ProposalDetailsModal render:', { proposal, user });

  if (!proposal) {
    console.log('No proposal provided to modal');
    return null;
  }
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{formatDate(proposal.submittedAt || proposal.createdAt)}</div>
                  </div>
